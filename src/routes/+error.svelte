...
<div class="flex flex-col items-center justify-center min-h-screen p-4">
	{#if $page.error}
		<h1 class="font-semibold text-gray-600 dark:text-gray-400 mb-4">{$page.error.message}</h1>
	{:else}
		<h1 class="font-semibold text-gray-600 dark:text-gray-400 mb-4">Unknown error occurred</h1>
	{/if}
	<button
