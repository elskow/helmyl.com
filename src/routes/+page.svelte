		...
		<section class="pt-10 relative">
			...
			>
				{#each technologies as { name, icons: Icon, link, accentColor }}
					...
					>
						<Icon
							class="w-6 h-6 grayscale filter group-hover:grayscale-0 transition-all duration-300"
						/>
						<span
							class="block text-xs sm:text-sm text-gray-600 transition-colors duration-300 group-hover:text-[var(--tech-color)]"
						>
							{name}
						</span>
					</a>
