...
<main class="max-w-4xl mx-auto md:p-8 p-4">
	<section>
		...
		<article class="pt-10 text-sm sm:text-base text-dark-600 dark:text-dark-300 space-y-4">
			<p>
		...
		<section class="pt-10 relative">
			<h2 class="text-base sm:text-lg font-medium text-midnight-800 dark:text-dark-100 no-gradient">
